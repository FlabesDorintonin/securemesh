...
interface SecureMeshRepository {
    ...
    val contactProfiles: StateFlow<Map<NodeId, ContactProfile>>
    ...
    suspend fun raiseSos(type: Int = 0): Result<String>
    ...
    suspend fun clearBleRadar(): Result<Unit>
    suspend fun updateContactProfile(nodeId: NodeId, alias: String?, note: String?, notePinned: Boolean)
    suspend fun clearContactProfile(nodeId: NodeId)
