...
data class ContactProfile(
    ...
    fun displayName(fallback: String): String = alias?.trim()?.takeIf { it.isNotEmpty() } ?: fallback
}
...
enum class CommandNoticeKind { RETURN, CHECK_IN, HOLD, MOVE_TO_WAYPOINT }

data class CommandNotice(
    val id: String,
    val origin: NodeId,
    val destination: NodeId,
    val kind: CommandNoticeKind,
    val targetPosition: NodePosition? = null,
